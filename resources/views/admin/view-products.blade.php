            ...
            <tbody>
                @forelse ($products as $product)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.edit-product', $product->product_id) }}" class="btn btn-sm btn-info">Edit</a>
                            <form action="{{ route('admin.delete-product', $product->product_id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
