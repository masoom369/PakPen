            ...
            <div class="grid grid-cols-6 gap-6">
                ...
                <form action="{{ route('seller.update-book', $book->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        @if($book->b_image)
                            <img src="{{ asset($book->b_image) }}" width="100" alt="{{ $book->b_name }}" class="d-block mb-2">
                        @endif
                    ...
                    <div class="mb-3">
                        ...
                        @if($book->b_pdf)
                            <p class="text-sm text-gray-600">Current PDF: <a href="{{ asset($book->b_pdf) }}" target="_blank">View PDF</a></p>
                        @endif
